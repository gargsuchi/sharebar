...
/**
 * Tests the conversion of hook_init() into an event subscriber.
 *
 * @group DMU
 */
class HookInitTest extends KernelTestBase {
  ...
  public function setUp() {
    ...
    $this->plugin = \Drupal::service('plugin.manager.drupalmoduleupgrader.module')->createInstance('HookInit');
  }
  ...
  public function testConvert() {
    ...
    $file = $this->target->getPath('src/EventSubscriber/InitSubscriber.php');
    ...
    $class = $doc
      ...
      ->getBody()
      ->children(Filter::isClass('InitSubscriber'))
      ->get(0);
    ...
    $expected = [
      'class' => 'Drupal\foobar\EventSubscriber\InitSubscriber',
      'tags' => [
        ['name' => 'event_subscriber'],
      ],
    ];
    $this->assertIdentical($expected, $services['services']['init_subscriber']);
  }
